...
function _precompile_()
    ...
    Base.precompile(Tuple{Core.kwftype(typeof(Plots.pie)),Any,typeof(pie),Any,Vararg{Any,N} where N})
    ...
    Base.precompile(Tuple{typeof(Base.Broadcast.broadcasted),Base.Broadcast.Style{Tuple},Function,Base.Broadcast.Broadcasted{Base.Broadcast.Style{Tuple},Nothing,typeof(typeof),Tuple{Tuple{Plots.Spy}}}})
    ...
    Base.precompile(Tuple{typeof(Plots.gr_draw_spine),Plots.Subplot{Plots.GRBackend},Plots.Axis,Segments{Tuple{Float64,Float64}}})
    ...
    Base.precompile(Tuple{typeof(RecipesBase.apply_recipe),Dict{Symbol,Any},Type{Val{:surface}},Plots.Plot{Plots.GRBackend}})
